...
<article> 
    ...
    <h3 class="name">Sarah McLaughlin</h3>
    <figure class="small">
            <img class="img-right small" alt="Sarah McLaughlin" 
                 src="../images/Sarah.jpg">
        <p class="about">Sarah is the lead web developer for Regional Recipes. She is from Needham, 
    ...
    <h3 class="name">Elizabeth Bambury</h3>
    <figure class="small">
            <img class="img-right small" alt="Elizabeth Bambury" 
                 src="../images/Liz.jpg">
        <p class="about">Liz Bambury is a junior web developer for Regional Recipes. 
    ...
    <h3 class="name">Julia Beatty</h3>
    <figure class="small">
            <img class="img-right small" alt="Julia Beatty" 
                 src="../images/Julia.jpg">
        <p class="about">Julia Beatty is a junior web designer for Regional Recipes. She is a 
