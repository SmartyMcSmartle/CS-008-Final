...
<article> 
    ...
    <p class="faq">You can start by going to the country page that you would like to explore 
    ...
    <p class="faq">Once you are on the recipe page that you love, you can either copy and 
    paste the recipe into a word document or bookmark it.</p>
    <h3>Can I use your recipes on my website/blog?</h3>
    <p class="faq">Unfortunately, recipes cannot be reproduced or distributed to third parties,
    including other websites for copyright reasons and as per our legal notices.</p>
    <h3>What do I get as a subscriber?</h3>
    <p class="faq">As a subscriber to our Regional Recipes email list, you will have unlimited
    ...
    <p class="faq">We are always excited to try new recipes! For that reason, we have included 
